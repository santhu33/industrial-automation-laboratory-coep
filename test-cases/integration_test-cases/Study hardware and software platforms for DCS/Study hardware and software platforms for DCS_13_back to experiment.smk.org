...
* Objective
  - To view the list of experiments link in “Study hardware and software platforms for DCS” experiment
...
* Test Step    
  - Click on the list of experiments link
  - View the list of experiments page

* Expected result     
  - lis of experiments page should be opened
