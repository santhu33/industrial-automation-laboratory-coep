...
# Usage: Installing dependencies for industrial-automation-laboratory-coep
RUN apt-get install -y make rsync apache2 wget php5

RUN mkdir /industrial-automation-laboratory-coep

COPY src/ /industrial-automation-laboratory-coep/src

WORKDIR ./industrial-automation-laboratory-coep/src
